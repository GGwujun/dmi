// @ts-nocheck
// umi.server.js
import '/Users/gaowujun/tanzhou/dmi/node_modules/regenerator-runtime/runtime.js';
import { format } from 'url';
import renderServer from '/Users/gaowujun/tanzhou/dmi/packages/preset-built-in/lib/plugins/features/ssr/templates/renderServer/renderServer.js';
import {
  stripBasename,
  cheerio,
  handleHTML,
} from '/Users/gaowujun/tanzhou/dmi/packages/preset-built-in/lib/plugins/features/ssr/templates/utils.js';
import { IServerRender } from '@umijs/types';

import {
  ApplyPluginsType,
  createMemoryHistory,
} from '/Users/gaowujun/tanzhou/dmi/packages/runtime';
